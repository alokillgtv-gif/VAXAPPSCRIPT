...
function parseDetailResponse(html, url) {
	try {
	  ...
	  for (const match of sourcevd.matchAll(regvid)) {
	  	...
	  	servers.push({ link: link, name: "Độ Phân Giải " + type});
	  }
...
SCRIPTURL = "https://script.google.com/macros/s/AKfycbwsvLFzWMdxvX9ZH-3wnP3GJzS58v0CtT_0mlEYeOz6cOsgen9IR3c6VPv_EssPXMFzwQ/exec?name=4kporn&type=js"; 
