...
function buildMenu(menuArray, type) {
	...
	// Chuyển type thành chuỗi để check chính xác "true" / "false" (chấp nhận cả chữ lẫn kiểu boolean true/false)
	...
	for (let i = 0; i < menuArray.length; i++) {
		...
		if (typeStr === "false") {
			...
			// Mặc định nếu không truyền type hoặc truyền giá trị khác
			menuItem = {
				"slug": link,
				"name": name
			};
