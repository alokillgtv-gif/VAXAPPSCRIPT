BASEURL = "https://xnhau.you";

function getManifest() {
	return JSON.stringify({
		"id": "xnhau",
		"name": "Xnhau",
		"description": "XXX Clip VN",
		"version": "1.0",
		"baseUrl": "https://xnhau.you",
		"iconUrl": "https://xnhau.you/contents/laelqdaetfol/theme/logo.png",
		"isEnabled": true,
		"isAdult": true,
		"type": "MOVIE",
		"playerType": "auto"
...
// https://xnhau.you/?mode=async&function=get_block&block_id=list_albums_index_albums&sort_by=post_date&from_albums=10
function getHomeSections() {
    var listurl = "[{\"link\":\"/\",\"name\":\"Hàng Mới\"}]";
	...
	try {
		...
		_$(html).find(".item").find("a").each(function() {
			...
			if (src.indexOf("data:image") > -1) {
				src = this.find("img").attr("data-preview");
			}
