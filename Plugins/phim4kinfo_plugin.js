...
function getManifest() {
    return JSON.stringify({
        ...
        "version": "1.0",
        "BASEURL": "https://phim4k.info",
        "iconUrl": "https://i.imgur.com/74EUoki.png",
        "isEnabled": true,
        "type": "VIDEO",
        "playerType": "embed"
    });
...
// https://phim4k.info/video?page=4
...
function getUrlList(slug, filtersJson) {
  try {
    ...
    if (slug && slug.indexOf("http") > -1 || slug.indexOf("search") > -1) {
      filtersJson = filtersJson.replace(/([{,])\s*([a-zA-Z0-9_]+)\s*:/g, '$1"$2":').replace(/:,/g, ':');
...
// https://phim4k.info/search?keyword=L%E1%BB%97%20Nh%E1%BB%8B&page=2
// https://phim4k.info/genre/han-quoc-18?page=6
// https://phim4k.info/video?page=8
...
function parseListResponse(html, $url) {
  try {
    ...
    _$(html).find(".last-film-box").find("li").each(function() {
      var href = this.find("a").attr("href");
      var title = this.find("a").attr("title");
      var src = this.find(".public-film-item-thumb").attr("style");
      // background-image:url('/images/thumbnails/chong-mai-me-lam-viec-vo-dit-nhau-cung-cau-trai-hang-xom-khoai-to.jpg')
...
function getLISTmenu() {
    return `
/trending@@Xu Hướng
/search?keyword=hi%E1%BA%BFp%20d%C3%A2m@@Hiếp Dâm
/search?keyword=t%E1%BA%ADp+th%E1%BB%83@@Tập Thể
/search?keyword=lo%E1%BA%A1n+lu%C3%A2n@@Loạn Luân
/search?keyword=L%E1%BB%97+Nh%E1%BB%8B@@Lỗ Nhị
/genre/av-khong-che@@Không Che
/genre/han-quoc-18@@Hàn Quốc
/genre/my-chau-au@@Châu Âu
/genre/trung-quoc@@Trung Quốc
/genre/viet-nam-clip@@Việt Nam
/genre/vietsub@@Vietsub
`
}
