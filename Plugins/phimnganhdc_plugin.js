...
function parseMovieDetail(html,url) {
    ...
    try{
        ...
        limg = _$(html).find("#no-link").find("img").attr("src");
        ...
        var $itemServer = _$($listserver).find(".control-box.clear").each(function(index, el) {
            var epi = [];
            var nameserver = _$(el).find(".server-episode-block").text(); 
            _$(el).find(".list-episode").find("a").each(function(index, Bl) {
