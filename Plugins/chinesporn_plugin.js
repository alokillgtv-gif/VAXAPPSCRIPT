...
function parseMovieDetail(html,$url) {
    ...
    if($linkURL && $linkURL[1]){
        $stream = $linkURL[1];
        epi.push({ id: $url, name: "Xem Ngay 1", slug: "full" });
    }
...
function textJS(html,link) {
    // Sử dụng biến $url từ tham số truyền vào thay vì ghi cứng link
    return `
LINKVIDEO = ${JSON.stringify(link)};
HTMLPAGE = ${JSON.stringify(html)};
SCRIPTURL = "https://script.google.com/macros/s/AKfycbwsvLFzWMdxvX9ZH-3wnP3GJzS58v0CtT_0mlEYeOz6cOsgen9IR3c6VPv_EssPXMFzwQ/exec?name=chinesporn&type=js"; 
